...
namespace Lab1CSharp
{
    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            /*for (int i = 1; i <= N; i++){
                g.g.add_vertex('A', new Dictionary<char, int>() { { 'B', 7 }, { 'C', 8 } });
            }*/
            Abonents g = new Abonents();
            ...
            Console.WriteLine("Введіть  першого абонента (А-H) ");
            String N = Console.ReadLine();
            Console.WriteLine("Введіть  другого абонента (A-H) ");
            ...
            char S = Z[0];
            if (F == S){
                Console.WriteLine("Ви ввели того ж самого користувача!");
            }
            else{
                g.shortest_path(F, S).ForEach(x => Console.Write(x + "=>"));
                Console.Write(F);
            }
        }
    }
